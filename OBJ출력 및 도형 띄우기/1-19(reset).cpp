...
void Timer(int val) {
	...
	case 3: //빨강 1
		if (g_isOn2) {
			...
			g_Shape[4].AR_matrix = glm::rotate(g_Shape[4].AR_matrix, glm::radians(3.0f), glm::vec3(0.0f, 1.0f, 0.0f));
			glutTimerFunc(17, Timer, 3);
		}
		break;
	case 4: //빨강 2
		if (g_isOn2) {
			...
			g_Shape[2].AR_matrix = glm::rotate(g_Shape[2].AR_matrix, glm::radians(3.0f), glm::vec3(1.0f, 0.0f, 0.0f));
			//g_Shape[11].AR_matrix = glm::rotate(g_Shape[11].AR_matrix, glm::radians(-3.0f), glm::vec3(1.0f, 1.0f, 0.0f));
			//g_Shape[11].AR_matrix = glm::rotate(g_Shape[11].AR_matrix, glm::radians(-3.0f), glm::vec3(1.0f, 0.0f, 0.0f));

			g_Shape[5].AR_matrix = glm::rotate(g_Shape[5].AR_matrix, glm::radians(-3.0f), glm::vec3(0.0f, 1.0f, 0.0f));
			//g_Shape[5].AR_matrix = glm::rotate(g_Shape[5].AR_matrix, glm::radians(-3.0f), glm::vec3(1.0f, 1.0f, 0.0f));
			g_num = 1;
			glutTimerFunc(25, Timer, 4);
		}
		break;
	case 5: //빨강 3
		if (g_isOn2) {
			...
			//}
			g_Shape[3].AR_matrix = glm::rotate(g_Shape[3].AR_matrix, glm::radians(3.0f), glm::vec3(0.0f, 1.0f, 0.0f));
			g_Shape[3].AR_matrix = glm::rotate(g_Shape[3].AR_matrix, glm::radians(-3.0f), glm::vec3(1.0f, 0.0f, 0.0f));
			//g_Shape[12].AR_matrix = glm::rotate(g_Shape[12].AR_matrix, glm::radians(-3.0f), glm::vec3(0.0f, 1.0f, 0.0f));
			//g_Shape[12].AR_matrix = glm::rotate(g_Shape[12].AR_matrix, glm::radians(3.0f), glm::vec3(1.0f, 0.0f, 0.0f));
			g_Shape[6].AR_matrix = glm::rotate(g_Shape[6].AR_matrix, glm::radians(3.0f), glm::vec3(0.0f, 1.0f, 0.0f));
			//g_Shape[6].AR_matrix = glm::rotate(g_Shape[6].AR_matrix, glm::radians(-3.0f), glm::vec3(1.0f, 0.0f, 0.0f));
			g_num1 = 1;
			glutTimerFunc(30, Timer, 5);
		}
		break;
